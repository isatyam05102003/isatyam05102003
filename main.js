...
function item1(a) {
    ...
    if (a != select2) {
        ...
        document.getElementById("img1Link").href = product[a].link; // Set link for image
    } else {
        ...
        document.getElementById("img1Link").href = "#"; // Reset link
    }
}
...
function item2(a) {
    ...
    if (a != select1) {
        ...
        document.getElementById("img2Link").href = product[a].link; // Set link for image
    } else {
        ...
        document.getElementById("img2Link").href = "#"; // Reset link
    }
}
